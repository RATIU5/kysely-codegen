...
type PostgresBunAdapterOptions = {
  dateParser?: DateParser;
  numericParser?: NumericParser;
};

export class PostgresBunAdapter extends Adapter {
  ...
  override readonly imports = {
    IPostgresInterval: new ModuleReferenceNode('postgres-bun-interval'),
  };
  ...
  constructor(options?: PostgresBunAdapterOptions) {
    super();
